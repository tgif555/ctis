											...
											<td>
												<table class="table-bordered" border=0 width="100%" cellpadding=3 cellspacing=0>
													...
													<tr>
														...
														<td>
															...
															<button type="button" name="sptm_customer_help" id="sptm_customer_help" class="btn btn-default" style="vertical-align: top;height:25px;margin:auto" 
																OnClick="helppopup('../_help/getcustampv.php','','','',document.all.sptm_customer_number.value)" data-dismiss="modal">
														...
														<td>
															<table border=0>
																...
																while($r_delivery_list=sqlsrv_fetch_array($result_delivery_list, SQLSRV_FETCH_ASSOC)) {
																	...
																	<td><input type="radio" name="sptm_delivery_mth" class="inputtext_s" value="<?php echo $delivery_code;?>" onclick="radiohighlight(sptm_delivery_mth)">&nbsp;<span class='txtdata'><?php echo $delivery_name;?></span></td>
																	<?php
																	$col++;
													...
													<tr>
														...
														<td><input type="text" name="sptm_delivery_mth_desc" id="sptm_delivery_mth_desc" class="inputtext_s" placeholder="* ระบุหมายเหตุการจัดส่ง" style="width: 250px;" maxlength="255"></td>										
														<td></td>
													</tr>
													<tr>
														<td></td>
