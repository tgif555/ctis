<?php
	...
	$header =
		"<table width=100% cellpadding=5 cellspacing=5 style='border: 1px dotted black; border-collapse: separate;font-size:12pt'>" .
			"<tr>".
				...
				"<td style='width:33%;text-align:center;font-size:12pt'>ใบส่งกระเบื้องตัวอย่าง<br><span style='font-size:8pt'>(C:วิธีการจัดส่ง/ผู้ขอเบิก)</span></td>".
		...
		"<table width=100% style='border: 1px dotted black; border-collapse: collapse;font-size:8pt'>" .
			...
			"<tr>".
				...
				"<td align=right><b>ชื่อผู้ขอเบิก:</b></td>".
			...
			"<tr><td colspan=4 style='height:5px'></td></tr>" .
		"</table>" .
		"<table width=100% cellpadding=5 cellspacing=5 style='border-collapse: collapse;border: 1px dotted black; font-size:7pt'>" .
			"<tr>" .
				"<td style='border: 1px dotted black;width:50px;text-align:center'><b>ลำดับ</b></td>".
				"<td style='border: 1px dotted black;width:80px;text-align:center'><b>Package No</b></td>".
				"<td style='border: 1px dotted black;width:80px;text-align:center'><b>หมายเลขใบเบิก</b></td>".
				"<td style='border: 1px dotted black;width:200px;text-align:center'><b>ชื่อลูกค้า</b></td>".
				...
				"<td style='border: 1px dotted black;text-align:center'><b>น้ำหนัก</b><span style='font-size:6pt;'> (KG)</span></td>".
			"</tr>".
		"</table>";
	...
	$pdf->WriteHTML("<table width=100% cellpadding=5 cellspacing=5 style='border-collapse: collapse;border: 1px dotted black; font-size:7pt'>");
	...
	while($r_ivd = sqlsrv_fetch_array($result_ivd, SQLSRV_FETCH_ASSOC)) {	
		...
		if($ivd_customer_number != "DUMMY") {
			...
			$ivd_customer_name = '<font color=red>[DUMMY]</font> ' .$ivd_customer_dummy;
		}
		...
		$data = "<tr>" .
				...
				"<td style='border: 1px dotted black;width:80px;text-align:center'>$ivd_dlvm_nbr</td>".
				"<td style='border: 1px dotted black;width:80px;text-align:center'>$ivd_sptm_nbr</td>".
				"<td style='border: 1px dotted black;width:200px;'>$ivd_customer_name</td>".
				"<td style='border: 1px dotted black;width:200px;'>$ivd_sptm_expect_receiver_name</td>".
	...
	for ($j=$n+1; $j <= 8; $j++) {
		$data = "<tr>" .
					...
					"<td style='border: 1px dotted black;width:80px;text-align:center'></td>".
					"<td style='border: 1px dotted black;width:80px;text-align:center'></td>".
					"<td style='border: 1px dotted black;width:200px;text-align:center'></td>".
					"<td style='border: 1px dotted black;width:200px;text-align:center'></td>".
					"<td style='border: 1px dotted black;width:50px;text-align:center'></td>".
