<?php
	...
	$header =
		...
		"<table width=100% cellpadding=5 cellspacing=5 style='border-collapse: collapse;border: 1px dotted black; font-size:7pt'>" .
			"<tr>" .
				...
				"<td style='border: 1px dotted black;width:200px;text-align:center'><b>ชื่อผู้ขอเบิก</b></td>".
	...
	while($r_ivd = sqlsrv_fetch_array($result_ivd, SQLSRV_FETCH_ASSOC)) {	
		...
		$data = "<tr>" .
				...
				"<td style='border: 1px dotted black;width:200px;'>(&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;)  $ivd_sptm_req_by_name</td>".
