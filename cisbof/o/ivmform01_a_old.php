<?php
	...
	$header =
		...
		"<table width=100% cellpadding=5 cellspacing=5 style='border-collapse: collapse;border: 1px dotted black; font-size:6pt'>" .
			"<tr>" .
				...
				"<td style='border: 1px dotted black;width:60px;text-align:center'><b>เลขที่ใบเบิก</b></td>".
				"<td style='border: 1px dotted black;width:100px;text-align:center'><b>ชื่อผู้ขอเบิก</b></td>".
				"<td style='border: 1px dotted black;width:280px;text-align:center'><b>หมายเหตุการจัดส่ง</b></td>".
				"<td style='border: 1px dotted black;width:80px;text-align:center'><b>ชื่อผู้รับสินค้า</b></td>".
				"<td style='border: 1px dotted black;width:50px;text-align:center'><b>รายการ</b></td>".
				"<td style='border: 1px dotted black;text-align:center'><span style='font-size:6pt;'> (KG)</span></td>".
			"</tr>".
		"</table>";
	...
	while($r_ivd = sqlsrv_fetch_array($result_ivd, SQLSRV_FETCH_ASSOC)) {	
		...
		$data = "<tr>" .
				...
				"<td style='border: 1px dotted black;width:70px;text-align:center'>$ivd_dlvm_nbr</td>".
				"<td style='border: 1px dotted black;width:60px;text-align:center'>$ivd_sptm_nbr</td>".
				"<td style='border: 1px dotted black;width:100px;'>$ivd_sptm_req_by_name</td>".
				"<td style='border: 1px dotted black;width:280px;'>$ivd_sptm_delivery_mth_desc</td>".
				"<td style='border: 1px dotted black;width:80px;'>$ivd_sptm_expect_receiver_name</td>".
	...
	for ($j=$n+1; $j <= 8; $j++) {
		$data = "<tr>" .
					...
					"<td style='border: 1px dotted black;width:70px;text-align:center'></td>".
					"<td style='border: 1px dotted black;width:60px;text-align:center'></td>".
					"<td style='border: 1px dotted black;width:100px;text-align:center'></td>".
					"<td style='border: 1px dotted black;width:280px;text-align:center'></td>".
