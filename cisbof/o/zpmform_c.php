<?php
	...
	$header =
		...
		"<table width=100% style='border: 1px dotted black; border-collapse: collapse;font-size:8pt'>" .
			...
			"<tr>".
				"<td style='width:100px' align=right><b>สถานที่จัดส่ง:</b></td>".
				"<td>[".$sptm_delivery_mth."]-".$sptm_delivery_mth_name. " ผู้ขอเบิก: " . $sptm_req_by_name . " </td>".
			"</tr>" .
			"<tr><td colspan=4 style='height:5px'></td></tr>" .
		"</table>" .
		...
		"<table width=100% cellpadding=5 cellspacing=5 style='border-collapse: collapse;border: 1px dotted black; font-size:8pt'>" .
			"<tr>" .
				...
				"<td style='border: 1px dotted black;width:250px;text-align:center'><b>ลูกค้า</b></td>".
	...
	while($r_dlvm = sqlsrv_fetch_array($result_dlvm, SQLSRV_FETCH_ASSOC)) {	
		...
		$data = "<tr>" .
				...
				"<td style='border: 1px dotted black;width:250px;'>$sptm_cust_name $dlvm_packing_location</td>".
				"<td style='border: 1px dotted black;width:150px;text-align:center'>$sptm_cust_amphur/$sptm_cust_province</td>".
				"<td style='border: 1px dotted black;width:150px;'>$dlvm_sptm_req_by_name</td>".
				"<td style='border: 1px dotted black;width:60px;text-align:center'>$dlvm_packing_weight</td>".
				"<td style='border: 1px dotted black;width:150px;text-align:center'>$dlvm_sptm_delivery_mth_desc</td>".
				"</tr>";
		if ($n == $dlvm_nbr_count) {
