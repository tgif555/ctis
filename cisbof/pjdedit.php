<?php
	...
	$pjm_nbr = decrypt(html_escape($_REQUEST['pjmnumber']), $key);
	$can_edit = true;
	//
	...
	if ($rec_pjm) {
		...
		$path = "pjmall.php?msg=กรุณาทำรายการใหม่อีกครั้ง "; 
																...
																<div class="row">
																	<div class="col-lg-4 col-md-12 col-sm-12">
																		<div class="form-group">
																			...
																			<input type="text" id="pjm_nbr_show" name ="pjm_nbr_show" value="<?php echo $pjm_nbr; ?>"  class="form-control " placeholder="Project Number Auto Generate" value="" disabled>
																		</div>
																		<div class="form-group">
																				...
																				<div class="row">
																					<div class="col-md-4">
																						<div class="form-group">
																							...
																							<div class="input-group input-group">
																								<input type="text" name="pjm_district" id="pjm_district" value="<?php echo $pjm_district; ?>" class="form-control" placeholder="District">
																								<!--<div class="input-group-append">
																									<span class="input-group-text"
																										OnClick="helppopup('../_help/getamphur_project.php','frm_pjm_edit','pjm_amphur_id','pjm_province_id','')" data-dismiss="modal">
																						...
																						<div class="form-group">
																							...
																							<div class="input-group input-group">
																								<input type="text" name="pjm_amphur" id="pjm_amphur" value="<?php echo $pjm_amphur; ?>" class="form-control" placeholder="Amphur">
																								<div class="input-group-append">
																									<span class="input-group-text"
																										OnClick="helppopup('../_help/getamphur_project.php','frm_pjm_edit','pjm_amphur','pjm_province','')" data-dismiss="modal">
																										<i class="feather icon-search"></i>
																									</span><!---->
																								</div>
																							</div>
																					...
																					<div class="col-md-4">
																						<div class="form-group">
																							...
																							<div class="input-group input-group">
																								<input type="text" name="pjm_province" id="pjm_province" value="<?php echo $pjm_province; ?>" class="form-control" placeholder="Province">
																								<div class="input-group-append">
																									<span class="input-group-text"
																										OnClick="helppopup('../_help/getprovince_project.php','frm_pjm_edit','pjm_province','','')" data-dismiss="modal">
																										<i class="feather icon-search"></i>
																									</span><!---->
																								</div>
																							</div>
																					...
																					<div class="col-md-5">
																						<div class="form-group">
																							...
																							<div class="input-group ">
																								<input type="text" name="pjm_custpj_code" id="pjm_custpj_code" value="<?php echo $pjm_custpj_code; ?>" class="form-control"  placeholder="พิมพ์ชื่อ หรือ รหัสลูกค้า">
																								<div class="input-group-append">
																									<span class="input-group-text"
																										OnClick="helppopup('../_help/getcustomer_project.php','frm_pjm_edit','pjm_custpj_code','custpj_name',document.frm_pjm_edit.pjm_custpj_code.value)" data-dismiss="modal">
																										<i class="feather icon-search"></i>
																									</span>
																								</div>
																							</div>
																					...
																					<div class="col-md-7">
																						<div class="form-group">
																							<div class="controls">
																								...
																								<input type="text" id="custpj_name" value="<?php echo $custpj_name; ?>" class="form-control"  placeholder="Customer Name" disabled>
																							</div>
																						</div>	
																					</div>
																				</div>
																					...
																					<div class="col-md-12">
																						<div class="form-group">
																							<fieldset class="form-group">
																								...
																								<textarea class="form-control" id="custpj_addr" rows="6" placeholder="Customer Address" disabled><?php echo $custpj_addr; ?></textarea>
																							</fieldset>
																						</div>
																					</div>
																				</div>
																				<div class="row">
																					<div class="col-md-5">
																						<div class="form-group">
																							...
																							<input type="text" id="custpj_email" value="<?php echo $custpj_email; ?>" class="form-control" placeholder="Email" disabled>
																						</div>
																					</div>
																					 <div class="col-md-4">
																						<div class="form-group">
																							<label class="font-weight-bold">Tel.</label>
																							<input type="text" id="custpj_tel" value="<?php echo $custpj_tel; ?>" class="form-control" placeholder="Tel." disabled>
																						</div>
																					</div>
																					<div class="col-md-3">
																						<div class="form-group">
																							<label class="font-weight-bold">Line ID.</label>
																							<input type="text" id="custpj_lineid" value="<?php echo $custpj_lineid; ?>"  class="form-control" placeholder="Line ID" disabled>
																						</div>
																					</div>
																				</div>
																			</div>
																					...
																					<div class="col-md-12">
																						<div class="form-group">
																							<fieldset class="form-group">
																								...
																								<textarea class="form-control" id="pjm_contact_addr" name="pjm_contact_addr" id="pjm_contact_addr" rows="6" placeholder="Contact Address"><?php echo $pjm_contact_addr; ?></textarea>
																							</fieldset>
																						</div>
																					</div>
																				</div>
