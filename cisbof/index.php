...
<head>
    ...
    <link rel="stylesheet" type="text/css" href="../theme/app-assets/vendors/css/charts/jquery-jvectormap-2.0.3.css">
    <link rel="stylesheet" type="text/css" href="../theme/app-assets/vendors/css/charts/morris.css">
    <link rel="stylesheet" type="text/css" href="../theme/app-assets/vendors/css/extensions/unslider.css">
    <link rel="stylesheet" type="text/css" href="../theme/app-assets/vendors/css/weather-icons/climacons.min.css">
    <!-- END: Vendor CSS-->
...
<body class="vertical-layout vertical-menu 2-columns menu-collapsed  fixed-navbar" data-open="hover" data-menu="vertical-menu" data-col="2-columns">
	...
	<? include("../cismain/menu_footer.php"); ?>
    ...
    <script src="../theme/app-assets/vendors/js/extensions/jquery.knob.min.js"></script>
    <script src="../theme/app-assets/js/scripts/extensions/knob.js"></script>
    <script src="../theme/app-assets/vendors/js/charts/raphael-min.js"></script>
    <script src="../theme/app-assets/vendors/js/charts/morris.min.js"></script>
    <script src="../theme/app-assets/vendors/js/charts/jvector/jquery-jvectormap-2.0.3.min.js"></script>
    <script src="../theme/app-assets/vendors/js/charts/jvector/jquery-jvectormap-world-mill.js"></script>
    <script src="../theme/app-assets/data/jvector/visitor-data.js"></script>
    <script src="../theme/app-assets/vendors/js/charts/chart.min.js"></script>
    <script src="../theme/app-assets/vendors/js/charts/jquery.sparkline.min.js"></script>
    <script src="../theme/app-assets/vendors/js/extensions/unslider-min.js"></script>
    <link rel="stylesheet" type="text/css" href="../theme/app-assets/css/core/colors/palette-climacon.css">
