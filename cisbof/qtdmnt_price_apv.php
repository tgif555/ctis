<form id="frmapprove" name="frmapprove" autocomplete="OFF">
	<input type="hidden" name="action" value="<?php echo md5('qtmsaveapprove'.$user_login)?>">
	...
	<div class="row skin skin-square col-12">
		<div class="row col-lg-4">
			...
			<div class="col-lg-4">
				<input type="radio" class="bg-primary" name="qtm_approve_select" value="30">
				<label class="bg-success bg-dark font-weight-bold text-white">&nbsp;&nbsp;อนุมัติ&nbsp;&nbsp;</label>
			</div>
			<div class="col-lg-4">
				<input type="radio" name="qtm_approve_select" value="10">
				<label class="bg-blue font-weight-bold text-white">&nbsp;แก้ไขใหม่&nbsp;</label>
			</div>
			<div class="col-lg-4">
				<input type="radio" name="qtm_approve_select" value="800">
	...
	<div class="row col-12">
		<div class="row col-lg-4">
			<div class="col-lg-12">
				<div class="btn btn-sm btn-success" style="width:70px" onclick="price_approve_postform()">
