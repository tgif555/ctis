<!-- Navbar -->
<nav class="main-header navbar navbar-expand-md navbar-light navbar-white" style="background:#ADEA70">
	<div class="container">
		<a href="../template/index3.html" class="navbar-brand">
			<img src="../template/dist/img/AdminLTELogo.png" alt="AdminLTE Logo" class="brand-image img-circle elevation-3"
				style="opacity: .8">
			<span class="brand-text font-weight-light">CTIS SYSTEMS</span>
		</a>
		...
		<div class="collapse navbar-collapse order-3" id="navbarCollapse">
			...
			<ul class="navbar-nav">
				...
				<li class="nav-item">
					<a href="index3.html" class="nav-link">Projects</a>
				</li>
				<li class="nav-item">
					<a href="../cisbof/qtmall.php" class="nav-link">Quotation</a>
				</li>
