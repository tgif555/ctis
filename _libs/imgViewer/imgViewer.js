    ...
    $.bindViewer = function (elm) {
        ...
        function viewImg() {
            var $obj = $(this),
                ...
                $close = $("<a title='' style='position:absolute;z-index:9999999;left:50%;padding:11px 15px;cursor:pointer;background:black;color:white;border-radius:50%;font-family:Arial;font-size:14px;transition:background .5s;text-decoration:none;'>X</a>");
